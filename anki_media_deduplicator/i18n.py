...
_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "finding_candidates": "Finding duplicate candidates...",
        "quick_fingerprinting": "Quick-filtering large media...",
        "hashing_media": "Hashing candidate media...",
        "verifying_duplicates": "Byte-verifying duplicate media...",
        "scanning_references": "Scanning note references...",
        "building_plan": "Building dry-run plan...",
        "verifying_media": "Verifying media...",
        "scanning_notes_for_updates": "Scanning notes for updates...",
        "updating_notes": "Updating notes...",
        "verifying_references": "Verifying migrated references...",
        "registering_media": "Registering media deletions for sync...",
    ...
    "zh_CN": {
        ...
        "finding_candidates": "正在查找重复候选...",
        "quick_fingerprinting": "正在快速筛选大媒体文件...",
        "hashing_media": "正在计算候选媒体哈希...",
        "verifying_duplicates": "正在逐字节验证重复媒体...",
        "scanning_references": "正在扫描笔记引用...",
        "building_plan": "正在生成 Dry Run 计划...",
        "verifying_media": "正在验证媒体...",
        "scanning_notes_for_updates": "正在扫描待更新笔记...",
        "updating_notes": "正在更新笔记...",
        "verifying_references": "正在验证引用迁移结果...",
        "registering_media": "正在登记媒体同步删除记录...",
